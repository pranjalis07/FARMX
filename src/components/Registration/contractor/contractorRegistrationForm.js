...
import { addCompanyData, addData } from '../../../services/apis';
...
const steps = ['General Details', 'Company Details'];
...
export default function ContractorRegistrationForm() {
    ...
    const { activeStep, setActiveStep, companyData, setCompanyData, role } = React.useContext(StepContext);
